...
def build_parser():
    ...
    parser.add_argument("--run-name", type=str, default="", help="set name of run")
    parser.add_argument(
        "--result-run", type=str, default="", help="set type of result run to go on"
    )
    parser.add_argument("--detail", type=str, default="", help="append to --run-name")
    ...
    parser.add_argument(
        "--datasets",
        nargs="+",
        help="Datasets to use. If set then train/test datasets are ignored",
    )
    parser.add_argument(
        "--train-datasets",
        nargs="+",
    ...
    parser.add_argument(
        "--remove-start-tokens", action="store_true", help="remove start tokens"
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="using special speaker tokens",
    )
...
def analysis(config):
    ...
    if not config.load_model:
        logging.getLogger(__name__).error("Load model should be set")
        return
