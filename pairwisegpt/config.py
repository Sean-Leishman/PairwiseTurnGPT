...
EXPERIMENT_1 = [
    ...
    [
        ...
        "SERIALISED",
        "--detail",
        "TEST ON SERIALISED WITH ALL DATA",
        "--evaluate-on-serialised",
        "--filter-bc-overlap-token",
        "--datasets",
        "switchboard",
...
TIMING = [
    ...
    [
        "--run-name",
        " TIME_ALIGNED NO OVERLAP NO BACKCHANNEL",
        "--overwrite",
        "--evaluate-on-full",
        "--remove-overlaps",
        "--remove-backchannels",
    ...
    ["--run-name", "TIME_ALIGNED", "--evaluate-on-full", "--remove-start-tokens"],
]
...
EXPERIMENT_2 = [
    ...
    [
        "--run-name",
        "YIELD TIME ALIGNED WITH BACKCHANNELS",
        "--remove-overlaps",
        "--include-yield-token",
        "--remove-start-tokens",
    ],
    ...
    [
        "--run-name",
        "YIELD TIME ALIGNED WITH OVERLAPS",
        "--include-yield-token",
        "--remove-backchannels",
        "--remove-start-tokens",
    ],
    ...
    [
        "--run-name",
        "YIELD TIME_ALIGNED WITH BACKCHANNELS & OVERLAPS",
        "--include-yield-token",
        "--remove-start-tokens",
    ],
]
